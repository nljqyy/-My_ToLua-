...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		EPagePosTypeWrap.Register(L);
		EPageHideModeWrap.Register(L);
		EventTriggerListenerWrap.Register(L);
		LuaInterface_DebuggerWrap.Register(L);
		LuaProfilerWrap.Register(L);
		AtlasManagerWrap.Register(L);
		XPageManagerWrap.Register(L);
		ViewWrap.Register(L);
		BaseWrap.Register(L);
	...
	static int System_Func_string_UnityEngine_Object(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<System.Func<string,UnityEngine.Object>>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<System.Func<string,UnityEngine.Object>>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
	...
	static int System_Action_string_System_Action_UnityEngine_Object(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<System.Action<string,System.Action<UnityEngine.Object>>>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<System.Action<string,System.Action<UnityEngine.Object>>>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
